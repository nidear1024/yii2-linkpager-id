 ...
 * @since 2.0
 */
class GoLinkPager extends Widget
{
	
    /**
     * @var string pageId  exanple:jump  http://www.xqw.com/music/1207.html?page=2#jump.
    ...
    protected function registerLinkTags()
    {
        ...
        foreach ($this->pagination->getLinks() as $rel => $href) {
            if ($this->pageId){
                $view->registerLinkTag(['rel' => $rel, 'href' => $href.'#'.$this->pageId], $rel);
            }else{
    ...
    protected function renderPageButton($label, $page, $class, $disabled, $active)
    {
        ...
        if ($this->idParam == ''){
            ...
            $url = $this->pagination->createUrl($page).'#'.$this->idParam;
        }
